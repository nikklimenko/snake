export class Snake {
    ...
    addKeyboardHandler() {
        ...
        upArr.onclick = () => {this.currentDirection = 'up'}
        leftArr.onclick = () => {this.currentDirection = 'left'}
        rightArr.onclick = () => {this.currentDirection = 'right'}
        downArr.onclick = () => {this.currentDirection = 'down'}
    }
